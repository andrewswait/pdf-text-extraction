...
class Interval:
    ...
    def intersection(self, other) -> 'Interval':
        """ Return the interval nlp to self and other """
    ...
    def overlaps(self, other) -> bool:
        """ Return True if there exists an interval nlp to self and other """
        a, b = sorted((self, other))
...
class NamedInterval(Interval):
    ...
    def __repr__(self):
        return 'NamedInterval[{}: {}, {}]'.format(self.name, self.start, self.end)
